...
func getTrend(c echo.Context) error {
	...
	err = mc.Set(&memcache.Item{Key: "trend", Value: encodedRes})
	if err != nil {
...
func postIsuCondition(c echo.Context) error {
	...
	for _, cond := range req {
		...
		values = append(values, IsuCondition{
			JIAIsuUUID: jiaIsuUUID,
			Timestamp:  timestamp,
	...
	query := "INSERT INTO `isu_condition` (`jia_isu_uuid`, `timestamp`, `is_sitting`, `condition`, `level`, `message`) VALUES (:jia_isu_uuid, :timestamp, :is_sitting, :condition, :level, :message)"
